...
siriulx for modifying some recipes
version 1.0.0
requirements: GT, PR
*/
...
// Silicon Plate
FormingPress.addRecipe(<appliedenergistics2:item.ItemMultiMaterial:20>, <ProjRed|Core:projectred.core.part:12>, <appliedenergistics2:item.ItemMultiMaterial:19> * 0, 180, 16);
